...
|     markerFlags     |{ 'kill', 'death', 'assist', 'structure', 'dragon', 'herald', 'baron' } : true \| false |                all true                 | Choose which events are shown by default in the timeline when playing a recording.                                                                                                                                                                                                         |
